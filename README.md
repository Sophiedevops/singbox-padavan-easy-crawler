...
* 🔄 **Умная ротация прокси** — автоматический парсинг подписок, тест на скорость (latency) и выбор лучших узлов. Автоматическое переключение в случае "просадки" пинга до текущего узла (проверка раз в 3 минуты). 
